...
!всегде начинаем либо с гитхаба(если лежит на гитхабе), если локально, то начинается путь с го мод файла (что писали при инициализации модуля, первая строка .mod файла)
